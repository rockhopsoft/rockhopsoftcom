...
class RockHopSoftComSeeder extends Seeder
{
    /**
    ...
    <div class="row">
		...
		DB::table('sl_definitions')->insert([
			...
			'def_description' => 'rockhopsoft/rockhopsoftcom'
		]);
		DB::table('sl_definitions')->insert([
			'def_id' => 594,
			'def_database' => '1',
...
#pubFooter a:hover {
    text-decoration: underline;
		...
		DB::table('sl_definitions')->insert([
			...
			'def_description' => 'RockHopSoftCom'
		]);
		DB::table('sl_definitions')->insert([
			'def_id' => 463,
			'def_database' => '1',
	...
	DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/.DS_Store',
			'img_type' => 'ds_store',
			'img_file_size' => '6148'
		]);
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/drugstory.png',
			'img_type' => 'png',
			'img_file_size' => '25436',
			'img_width' => '410',
			'img_height' => '94'
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/openpolicecomplaints.png',
			'img_type' => 'png',
			'img_file_size' => '58173',
			'img_width' => '1636',
			'img_height' => '291'
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/PowerScoreLogo-.jpg',
			'img_type' => 'jpg',
			'img_file_size' => '17669',
			'img_width' => '700',
			'img_height' => '67'
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-01.png',
			'img_node_id' => '-3',
			'img_type' => 'png',
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-02.png',
			'img_type' => 'png',
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-03.png',
			'img_node_id' => '-3',
			'img_type' => 'png',
			'img_file_size' => '96009',
			'img_width' => '2037',
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-04.png',
			'img_node_id' => '-3',
			'img_type' => 'png',
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-05.png',
			'img_node_id' => '-3',
			'img_type' => 'png',
		...
		DB::table('sl_images')->insert([
			...
			'img_full_filename' => '/rockhopsoftcom/uploads/laravel-digital-ocean-06.png',
			'img_node_id' => '-3',
			'img_type' => 'png',
