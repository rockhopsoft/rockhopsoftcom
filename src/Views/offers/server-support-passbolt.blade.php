...
<div class="row">
    <div class="col-lg-4 pT30 pB30">
        <div class="pB15"><a href="https://www.passbolt.com/" target="_blank"
            ...
            alt="Passbolt logo" title="Passbolt logo"></a></div>
...
<div class="pT30">
    <div class="row">
        <div class="col-lg-5 pT15 pB15">
            ...
            <td class="taR">${{
                number_format($sols->getSol(804)->feeOnce, 2)
            }}</td>
            </tr>
            <tr>
            <td class="taL">Monthly Tech Support Fee</td>
            <td class="taR">${{
                number_format($sols->getSol(804)->feeMonth, 2)
            }}</td>
            </tr>
            <tr>
            <td class="taL">Monthly Hosting Costs</td>
            <td class="taR">${{
                number_format($sols->getSol(804)->feeHost, 2)
            }}</td>
            </tr>
            </table>
            </div>
...
<a href="https://community.passbolt.com/" target="_blank"
    >community.passbolt.com/</a><br />
<a href="https://www.youtube.com/@passboltpassword" target="_blank"
    >youtube.com/@passboltpassword</a><br />
</div>
        </div>
    </div>
</div>