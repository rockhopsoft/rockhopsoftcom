...
<div style="min-height: 400px;">
	...
	<div class="tab-content" id="myTabContent">
		<div class="tab-pane fade show active" id="scriptsJitsi" role="tabpanel" aria-labelledby="scriptsJitsi-tab">
			...
			<p>Run the <a href="https://github.com/rockhopsoft/install-scripts/blob/master/src/ubuntu20/jitsi-install.sh" target="_blank">Jitsi Install script</a>. This was most reliable when setting the Server Hostname to the domain name — for this example, <span class="red">rockhop.live</span>.</p>
...
# systemctl reload nginx</pre>
			<p><br /></p>
			<p><b>If all went well, then you should setup an SSL Certificate:</b></p>
<pre>/usr/share/jitsi-meet/scripts/install-letsencrypt-cert.sh</pre>
			<p><br /></p>
			<h5>Customize Jitsi (Optional)</h5>
			<p><b>If</b> you want to customize the site watermark logo, and favicon, just follow these extra steps:</p>
